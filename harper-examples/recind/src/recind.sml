...
fun main args = (* main (prog_name, args) = *)
    let
        ...
        val _ = print("exp(10)=" ^ Int.toString(exp(10)) ^"\n")
        val _ = print("fast_exp(10)=" ^ Int.toString(fast_exp(10)) ^"\n")
        val _ = print("iterative_fast_exp(10, 1)=" ^ Int.toString(iterative_fast_exp(10, 1)) ^"\n\n")

        val _ = print("gcd(21, 14)=" ^ Int.toString(gcd(21, 14)) ^"\n")
        val (d, a, b) = ggcd(21, 14)
        val _ = print("ggcd(21, 14)=(" ^ Int.toString(d) ^ ", " ^ Int.toString(a) ^ ", " ^ Int.toString(b) ^")\n")
    in
